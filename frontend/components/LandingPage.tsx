...
// useSyncExternalStore is the correct primitive for subscribing to a browser API
// like matchMedia -- it avoids both the "setState synchronously in an effect"
// anti-pattern and SSR hydration mismatches (via the server-snapshot fallback).
